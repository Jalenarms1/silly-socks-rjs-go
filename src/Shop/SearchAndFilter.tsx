    ...
    <div className="flex w-full md:justify-end">
      <div className="flex flex-col w-full md:w-[25%] gap-2">
          ...
          <div className="grid grid-cols-4 gap-1 px-1">
              <p className='text-sm font-semibold text-center active:scale-[.95] bg-red-500 p-1 rounded-sm text-white'>
              All
              </p>
              <p className='text-sm font-semibold text-center active:scale-[.95] bg-zinc-400 p-1 rounded-sm text-white'>
              Socks
              </p>
              <p className='text-sm font-semibold text-center active:scale-[.95] bg-zinc-400 p-1 rounded-sm text-white'>
              Slides
