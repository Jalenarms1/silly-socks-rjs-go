...
export const Cart = () => {
  ...
  return (
    <div className="min-h-screen p-6">
                ...
                <div key={i} className="flex items-start p-2  gap-2 h-fit bg-zinc-900 rounded-md">
                    <div className="bg-slate-700">
                        <img
                            ...
                            alt="Movie" 
                            className="w-16 h-20 shadow-sm shadow-zinc-300"
                        />
                    </div>
        ...
        {cart.length > 0 && <div className="flex flex-col items-end text-black mt-5 text-base">
            <div className="py-2 flex flex-col gap-2 w-1/2">
            ...
            <button onClick={submitCheckout} className="btn btn-warning mt-3 flex items-center w-1/2 px-6">
